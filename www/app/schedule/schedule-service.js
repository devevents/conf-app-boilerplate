...
angular.module('confboilerplate.schedule.services')
    ...
    this.get = function () {
        ...
        $http.get('assets/data/schedule.json')
            ...
            var day1 = _.filter(data, function (attraction) { return attraction.date === "day1"; }), day2 = _.filter(data, function (attraction) { return attraction.date === "day2"; });
            dfd.resolve({
                "day1": day1,
                "day2": day2
            });
...
//# sourceMappingURL=../../app/schedule/schedule-service.js.map